      ...
      <section className="py-20 bg-primary">
        <div className="max-w-[1200px] mx-auto px-6 text-center">
          <BlurFade>
            ...
            <Link
              href="/iletisim"
              className="inline-flex items-center gap-2 bg-white text-primary! px-8 py-4 rounded-xl font-semibold hover:bg-surface hover:shadow-xl transition-all duration-300 active:scale-[0.98]"
            >
              İletişime Geç
