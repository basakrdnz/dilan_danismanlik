...
const contactInfo = [
  {
    title: 'Konum',
    value: 'Ankara (Etimesgut & Çankaya)\nŞehirlerarası ve Online Hizmet Mevcut',
    icon: (
  ...
  {
    title: 'Telefon',
    value: '+90 552 715 11 01',
    href: 'tel:+905527151101',
    icon: (
      <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
  ...
  {
    title: 'E-posta',
    value: 'karakoccdilan@gmail.com',
    href: 'mailto:karakoccdilan@gmail.com',
    icon: (
      <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
...
export default function IletisimPage() {
  ...
  const handleSubmit = (e) => {
    e.preventDefault();
    const phone = '905527151101';
    const text = encodeURIComponent(
      `Merhaba, yeni bir iletişim formu dolduruldu:\n\n` +
            ...
            <BlurFade className="lg:col-span-3">
              <div className="bg-white rounded-2xl border border-border p-8 lg:p-10">
                ...
                <form onSubmit={handleSubmit} className="space-y-5">
                  ...
                  <button
                    type="submit"
                    className="flex items-center gap-3 bg-green-50 border border-green-200 rounded-xl p-3 hover:bg-green-100 transition-colors group w-full sm:w-auto"
                  >
                    ...
                    <span className="font-semibold text-green-700 pr-2">WhatsApp ile Gönder</span>
                  </button>
                </form>
              </div>
            </BlurFade>
