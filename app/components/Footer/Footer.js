        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-10 mb-12">
          ...
          <div className="flex flex-col gap-3">
            ...
            <div className="flex gap-3 mt-2">
              <a
                href="https://www.instagram.com/psk.dan.dilankarakoc"
                target="_blank"
              ...
              <a
                href="https://www.linkedin.com/in/dilan-karakoç-199098215/"
                target="_blank"
                rel="noopener noreferrer"
                className="w-9 h-9 rounded-lg bg-white/10 flex items-center justify-center text-white/70 hover:bg-primary hover:text-white transition-all duration-300"
                aria-label="LinkedIn"
          ...
          <div>
            ...
            <ul className="flex flex-col gap-3 list-none text-sm text-white/60">
              <li className="flex items-start gap-2">
                ...
                <a href="mailto:karakoccdilan@gmail.com" className="hover:text-white transition-colors">
                  karakoccdilan@gmail.com
                </a>
              </li>
              <li className="flex items-start gap-2">
                <svg className="w-4 h-4 mt-0.5 shrink-0 text-accent-light" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                ...
                <a href="tel:+905527151101" className="hover:text-white transition-colors">
                  +90 552 715 11 01
                </a>
              </li>
              <li className="flex items-start gap-2">
